...
[_COLEMAK] = LAYOUT_planck_grid(
    ...
    KC_LCTL, KC_A,    KC_R,    KC_S,    KC_T,    KC_D,    KC_H,    KC_N,    KC_E,    KC_I,    KC_O,    MOUSE,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    _______, _______, RAISE,   KC_RSFT,
    _______, BACKLIT, KC_LALT, CMD_EIS, LOWER,   KC_SPC,  KC_SPC,  KC_RSFT, CMD_KNA, KC_RALT, FNCTN,   _______
),

[_QWERTY] = LAYOUT_planck_grid(
    KC_ESC,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
    KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    _______, MOUSE,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    _______, _______, RAISE,   KC_RSFT,
    _______, BACKLIT, KC_LALT, CMD_EIS, LOWER,   KC_SPC,  KC_SPC,  KC_RSFT, CMD_KNA, KC_RALT, FNCTN,   _______
),
